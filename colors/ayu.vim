...
let s:palette.bg        = {'dark': "#0F1419",  'light': "#EDEDED",  'mirage': "#212733"}
...
let s:palette.panel     = {'dark': "#14191F",  'light': "#C4C4C4",  'mirage': "#272D38"}
let s:palette.guide     = {'dark': "#2D3640",  'light': "#B5B5B5",  'mirage': "#3D4751"}
let s:palette.line      = {'dark': "#151A1E",  'light': "#F3F3F3",  'mirage': "#242B38"}
let s:palette.selection = {'dark': "#253340",  'light': "#CECECE",  'mirage': "#343F4C"}
